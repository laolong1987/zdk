...
$.ligerui.controls.Grid.prototype.showFilter = function (_parms)
{
	var parms = _parms;
	var filter;
    ...
    g.winfilter.show();
    filter =filtercontainer.ligerFilter({ fields: getFields() });   
	return;
    ...
    function getFields()
    {
        ...
        $(g.columns).each(function ()
        {
        	if(this.display != undefined){
	            ...
	            if (isNumber) o.type = o.editor.type = "number";
	            if (isDate) o.type = o.editor.type = "date";
	            if (this.editor)
	            {
