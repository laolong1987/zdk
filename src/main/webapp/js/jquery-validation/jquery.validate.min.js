...
(function(c) {
	...
	c
			.extend(
					...
					{
						defaults : {
							messages : {}, groups : {}, rules : {}, errorClass : "error", validClass : "valid", errorElement : "label", focusInvalid : true, errorContainer : c([]), errorLabelContainer : c([]), onsubmit : true, ignore : [], ignoreTitle : false, onfocusin : function(a) {
								this.lastActive = a;
						...
						prototype : {
							init : function() {
								...
								if (a) {
									...
									for ( var b in a)
										this.errorList.push({
											message : a[b], element : this.findByName(b)[0]
										});
								...
								if (d.length) {
									...
									d = c("<" + this.settings.errorElement + "/>").attr({
										"for" : this.idOrName(a), generated : true
								...
								return c.data(a, "previousValue") || c.data(a, "previousValue", {
									old : null, valid : true, message : this.defaultMessage(a, "remote")
								})
							}
						},
						classRuleSettings : {
